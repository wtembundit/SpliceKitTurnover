...
cp "$REPO_ROOT/lua/scripts/export_markers_fcpxml.mjs" "$CONTENTS/Resources/scripts/"
...
cp -R "$REPO_ROOT/lua/scripts/lib" "$CONTENTS/Resources/scripts/"
...
find "$CONTENTS/Resources/scripts/node_modules" -name '.DS_Store' -delete
